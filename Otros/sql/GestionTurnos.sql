-- Acciones a realizar si utilizas MV:
-- 1- Cambiar pass de usuario root: ALTER USER 'root' IDENTIFIED BY 'aca_va_TU_clave'; FLUSH PRIVILEGES;
-- 1a- Modificar en: Persistencia/conexionBD.php el valor de clave elegido.
-- 2- Crear la base de datos: CREATE DATABASE GestionTurnos;
-- 3- Agregar este script al directorio de la MV en home/bitnami/sql
...
VALUES 
    (2, 1, '2025-08-22', '08:00:00', '08:45:00', TRUE),
    (2, 1, '2025-08-22', '09:00:00', '09:45:00', TRUE),
    (2, 1, '2025-08-22', '10:00:00', '10:45:00', TRUE),
    (3, 4, '2025-08-22', '08:00:00', '08:45:00', TRUE),
    (3, 4, '2025-08-23', '09:00:00', '09:45:00', FALSE),
    (3, 4, '2025-08-24', '10:00:00', '10:45:00', FALSE),
    (3, 4, '2025-08-25', '08:00:00', '08:45:00', TRUE),
    (3, 4, '2025-08-26', '09:00:00', '09:45:00', TRUE),
    (3, 4, '2025-08-27', '10:00:00', '10:45:00', TRUE);
...
VALUES 
    (1, '2025-08-22', 'Viernes', '09:00:00', '09:30:00', 30, 1, 1),
    (1, '2025-08-22', 'Viernes', '09:30:00', '10:00:00', 30, 1, 1),
    (1, '2025-08-23', 'Sabado', '10:00:00', '10:30:00', 30, 1, 0),  -- No disponible
    (2, '2025-08-22', 'Viernes', '09:00:00', '09:30:00', 30, 1, 1),
    (2, '2025-08-25', 'Lunes', '09:30:00', '10:00:00', 30, 1, 1),
    (2, '2025-08-24', 'Domingo', '10:00:00', '10:30:00', 30, 1, 0);  -- No disponible
