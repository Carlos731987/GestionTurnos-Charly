...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // $stmt = $conn->prepare("SELECT id FROM pacientes WHERE email = ?"); //Pensar si cambio acá la tabla de consulta
    $stmt = $conn->prepare("SELECT id_perfil FROM perfiles WHERE email = ?"); //Posible solución
